...
The app stores the outbound booking request and carrier response on the local shipment audit record. For Mothership, the audit also carries the TMS Reference / PO as local context on the local shipment record.
