...
const translations = {
  zh: {
    ...
    "Pickup address type": "提货地址类型",
    "Delivery address type": "派送地址类型",
...
const quoteIntakeFieldLabels = {
  ...
  "pickup.addressType": "Pickup address type",
  ...
  "delivery.addressType": "Delivery address type",
  ...
  "freight.unNumber": "Hazmat UN number",
  "freight.hazardClass": "Hazard class",
